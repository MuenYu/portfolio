...
date: 'Last Update: 2025.09'
banner: /static/highlight-banner.jpg
featured: true
category: biography
---
...
**Academic Excellence**, QUT Executive Deans’ Commendation: [Credential](https://me.mashiro.best/static/academic_transcript.pdf)
  ~ 2023, 2024
...
- **Hono**: fast backend APIs in Node.js when speed and simplicity are key.
...
- **Pulumi**: gaining hands-on experience with IaC to enable reproducible, scalable deployments.

## Code Editors
- **Zed + Codex**: my primary choice, ultra light-weight and fast combo
- **JetBrains IDEs**: when comprehensive debuging and inspection matters
...
• Model: Apple MacBook Pro 14 (2023)
